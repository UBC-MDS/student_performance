...
```{r, echo = FALSE, fig.align='center', fig.cap='Figure 1: Mean and spread for final grades'}
...
```{r, echo = FALSE, fig.align='center',fig.cap='Figure 2: Mean and 95% confidence interval for final grades'}
